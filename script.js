document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderNews(contents) {
        ...
        contents.forEach(content => {
            ...
            // 画像がある場合のみ表示
            const thumbnail = content.images?.[0] || content.image;
            const imageHtml = thumbnail
                ? `<div class="news-image"><img src="${escapeHtml(thumbnail.url)}" alt="${escapeHtml(thumbnail.alt || content.title)}" loading="lazy" width="400" height="225"></div>`
                : '';
